...
class CompanyCell: UITableViewCell {
  ...
  // declaring another imageview using "imageView" is prohibited, UICells already have this property
  ...
  override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
    ...
    nameFoundedDateLabel.leftAnchor.constraint(equalTo: companyImageView.leftAnchor, constant:50).isActive = true
